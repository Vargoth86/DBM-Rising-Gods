...
local timerSuppresserOne			= mod:NewTimer(70, "TimerSuppresserOne","Interface\\AddOns\\DBM-Core\\textures\\CryptFiendUnBurrow.blp")
local timerSuppresserTwo			= mod:NewTimer(61, "TimerSuppresserTwo","Interface\\AddOns\\DBM-Core\\textures\\CryptFiendUnBurrow.blp")
local timerSuppresserThree			= mod:NewTimer(61, "TimerSuppresserThree","Interface\\AddOns\\DBM-Core\\textures\\CryptFiendUnBurrow.blp")
local timerSuppresserFour			= mod:NewTimer(61, "TimerSuppresserFour","Interface\\AddOns\\DBM-Core\\textures\\CryptFiendUnBurrow.blp")
...
function mod:OnCombatStart(delay)
	...
	timerSuppresserTwo:Schedule(70)
	timerSuppresserThree:Schedule(131)
	timerSuppresserFour:Schedule(192)
	specWarnSuppresserOne:Schedule(70)
	soundSpecWarnSuppresser:Schedule(70, "Interface\\AddOns\\DBM-Core\\sounds\\RaidAbilities\\suppressersSpawned.mp3")
	specWarnSuppresserTwo:Schedule(131)
	soundSpecWarnSuppresser:Schedule(131, "Interface\\AddOns\\DBM-Core\\sounds\\RaidAbilities\\suppressersSpawned.mp3")
	specWarnSuppresserThree:Schedule(192)
	soundSpecWarnSuppresser:Schedule(192, "Interface\\AddOns\\DBM-Core\\sounds\\RaidAbilities\\suppressersSpawned.mp3")
	specWarnSuppresserFour:Schedule(253)
	soundSpecWarnSuppresser:Schedule(253, "Interface\\AddOns\\DBM-Core\\sounds\\RaidAbilities\\suppressersSpawned.mp3")
end
