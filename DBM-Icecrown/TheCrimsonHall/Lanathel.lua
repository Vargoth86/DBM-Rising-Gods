...
local berserkTimer					= select(3, DBM:GetMyPlayerInfo()) == "Lordaeron" and mod:NewBerserkTimer(300) or mod:NewBerserkTimer(320)
...
function mod:OnCombatStart(delay)
	...
	if self:IsDifficulty("normal10", "heroic10") then
		...
		warnInciteTerrorSoon:Schedule(130)
		warnInciteTerrorSoon:ScheduleVoice(130, "fearsoon")
	end
end
