...
local timerCombatStart			= mod:NewCombatTimer(15) -- Roleplay for first pull
local timerTargetSwitch			= mod:NewTimer(46.5, "TimerTargetSwitch", 70952)	-- every 46-47seconds
