...
local timerChokingGasBombCD			= mod:NewNextTimer(40, 71255, nil, nil, nil, 3)
...
function mod:OnCombatStart(delay)
	...
	timerUnstableExperimentCD:Start(32-delay)
...
function mod:SPELL_CAST_START(args)
	...
	elseif args:IsSpellID(72851, 72852, 71621, 72850) then		--Create Concoction (phase2 change)
		...
		if self:IsHeroic() then
			...
			timerMalleableGooCD:Start(60)
			soundMalleableGooSoon:Schedule(60-3, "Interface\\AddOns\\DBM-Core\\sounds\\RaidAbilities\\malleable_soon.mp3")
			timerChokingGasBombCD:Start(64)
			soundChokingGasSoon:Schedule(64-3, "Interface\\AddOns\\DBM-Core\\sounds\\RaidAbilities\\choking_soon.mp3")
			warnChokingGasBombSoon:Schedule(64-5)
