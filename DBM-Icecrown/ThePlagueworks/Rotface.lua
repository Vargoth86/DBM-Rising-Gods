...
local timerWallSlime			= mod:NewNextTimer(20, 69789) -- Edited.
local timerSlimeSpray			= mod:NewNextTimer(23, 69508, nil, nil, nil, 3)
...
local timerVileGasCD			= mod:NewNextTimer(26, 72272, nil, nil, nil, 3)
...
function mod:OnCombatStart(delay)
	timerWallSlime:Start(25-delay) -- Adjust from 25 to 9 to have a correct timer from the start
	timerSlimeSpray:Start(15-delay) -- Custom add for the first Slime Spray
	timerVileGasCD:Start(28-delay) -- Edited.
