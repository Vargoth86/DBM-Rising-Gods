...
local timerSubmerge			= mod:NewTimer(82, "TimerSubmerge", "Interface\\AddOns\\DBM-Core\\textures\\CryptFiendBurrow.blp", nil, nil, 6, DBM_CORE_L.IMPORTANT_ICON, nil, 1)
...
function mod:OnCombatStart(delay)
	...
	warnSubmergeSoon:Schedule(80-delay)
