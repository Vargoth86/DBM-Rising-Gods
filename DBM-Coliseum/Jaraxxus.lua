...
local timerCombatStart			= mod:NewCombatTimer(83)--roleplay for first pull
...
local timerNetherPowerCD		= mod:NewCDTimer(40, 67009, nil, "MagicDispeller", nil, 5, nil, DBM_CORE_L.MAGIC_ICON)
...
function mod:OnCombatStart(delay)
    ...
    timerNetherPowerCD:Start(18-delay)
	timerFleshCD:Start(15-delay)
	timerFlameCD:Start(11-delay)
